                 ...
                 {sessions.map(session => (
                     <div key={session.id} className="relative group mb-1">
                        <div
                            ...
                            className={`w-full text-left p-3 rounded-lg text-sm transition-all cursor-pointer select-none pr-8 flex items-center ${
                        ...
                        <button
                            ...
                            className={`absolute right-1 top-1/2 -translate-y-1/2 p-1.5 rounded-md hover:bg-slate-900/50 text-slate-400 hover:text-white transition-all z-10 ${
                                currentSessionId === session.id || activeMenuSessionId === session.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100 md:opacity-0'
                            }`}
                        >
